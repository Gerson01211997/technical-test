...
function InputComponent({
  ...
  const inputClasses = useMemo(() => {
    ...
    const iconClass = startIcon ? Styles.iconStart : endIcon ? Styles.iconEnd : '';
  ...
  return (
    <div className={Styles.wrapper}>
      ...
      <div className={Styles.inputContainer}>
        {startIcon && (
          <div className={`${Styles.iconWrapper} ${Styles.iconStartWrapper}`}>{startIcon}</div>
        )}

        <input {...props} className={inputClasses} />

        {endIcon && (
          <div className={`${Styles.iconWrapper} ${Styles.iconEndWrapper}`}>{endIcon}</div>
        )}
      </div>
